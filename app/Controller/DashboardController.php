...
class DashboardController
{
    ...
    private NotulensiRapat $notulensiModel;

    public function __construct()
    {
        $this->undanganModel = new UndanganRapat();
        $this->notulensiModel = new NotulensiRapat();
    ...
    public function downloadLaporan(): void
    {
        ...
        header('Content-Disposition: attachment; filename="laporan_rapat_' . $type . '_' . ($type === 'bulanan' ? $bulan . '_' : '') . $tahun . '.html"');
        echo $html;
        exit();
    }
